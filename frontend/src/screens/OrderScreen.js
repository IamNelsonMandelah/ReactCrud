              ...
              <Box>
                {loadingPay ? (
                  ...
                  <PayPalScriptProvider
                    options={{
                      clientId:
                        "AQMEumQ-Z3kiFCyo31l96mAg26dFJtcHz_8m6VD0HEKLtuDAxxjRzCG7kPhTQJUyHpsw5WYWwrw-8bHo",
                      components: "buttons"
                    }}
                  >
                    <PayPalButtons
                          ...
                          purchase_units: [
                            {
                              amount: {
                                ...
                                // currency_code: "USD" // Change this to the currency you want to use on production
                              }
                            }
                          ]
                        });
