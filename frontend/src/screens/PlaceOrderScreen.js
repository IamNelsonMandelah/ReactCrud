...
const PlaceOrderScreen = () => {
  ...
  switch (cart.shippingAddress.region) {
    case "Nairobi CBD":
      shippingPrice = 1000;
      break;

    case "Nairobi Outskirts":
      shippingPrice = 1500;
      break;
  ...
  console.log("Shipping Cost", cart.shippingPrice);
        ...
        <Flex direction="column">
          ...
          <Box borderBottom="1px" py="6" borderColor="gray.300">
            ...
            <Text>
              ...
              {cart.shippingAddress.postalCode},{cart.shippingAddress.region},
